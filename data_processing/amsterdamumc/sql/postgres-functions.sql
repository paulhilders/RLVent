-- Description: This query creates a set of sql functions that can be used in
--              other queries.
-- Taken from https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iv/concepts_postgres/postgres-functions.sql
SET search_path TO amsterdamumcdb_derived;
